...
public class VersionInfoHC4 {
    ...
    public static String getUserAgent(final String name, final String pkg, final Class<?> cls) {
        ...
        final VersionInfoHC4 vi = VersionInfoHC4.loadVersionInfo(pkg, cls.getClassLoader());
        final String release = (vi != null) ? vi.getRelease() : VersionInfoHC4.UNAVAILABLE;
        final String javaVersion = System.getProperty("java.version");
        return name + "/" + release + " (Java 1.5 minimum; Java/" + javaVersion + ")";
    }

} // class VersionInfoHC4
