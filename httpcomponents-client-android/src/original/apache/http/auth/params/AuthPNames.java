...
package original.apache.http.auth.params;
 ...
 * @since 4.0
 *
 * @deprecated (4.3) use {@link original.apache.http.client.config.RequestConfig}
 *   and constructor parameters of
 *   {@link original.apache.http.auth.AuthSchemeProvider}s.
*/
@Deprecated
public interface AuthPNames {
     ...
     * {@link original.apache.http.auth.Credentials}.
     * <p>
     ...
     *  {@link original.apache.http.auth.AuthScheme}s when authenticating with
     *  the target host.
     * <p>
     ...
     * {@link original.apache.http.auth.AuthScheme#getSchemeName()}.
     */
    public static final String TARGET_AUTH_PREF = "http.auth.target-scheme-pref";

    /**
     * Defines the order of preference for supported
     *  {@link original.apache.http.auth.AuthScheme}s when authenticating with the
     *  proxy host.
     * <p>
     * This parameter expects a value of type {@link java.util.Collection}. The
     * collection is expected to contain {@link String} instances representing
