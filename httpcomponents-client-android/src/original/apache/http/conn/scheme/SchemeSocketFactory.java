 ...
 * @since 4.1
 *
 * @deprecated (4.3) use {@link original.apache.http.conn.socket.ConnectionSocketFactory}
 */
@Deprecated
public interface SchemeSocketFactory {
     ...
     * <p/>
     * Please note that {@link original.apache.http.conn.HttpInetSocketAddress} class should
     ...
     * {@link original.apache.http.conn.HttpInetSocketAddress} can also ensure that no reverse
     ...
     *
     * @see original.apache.http.conn.HttpInetSocketAddress
     */
