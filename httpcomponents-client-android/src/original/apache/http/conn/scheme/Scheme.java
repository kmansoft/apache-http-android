...
import original.apache.http.conn.scheme.LayeredSocketFactory;
import original.apache.http.conn.scheme.SocketFactory;

import original.apache.http.annotation.Immutable;
import original.apache.http.util.Args;
import original.apache.http.util.LangUtils;
 ...
 * @since 4.0
 *
 * @deprecated (4.3) use {@link original.apache.http.conn.SchemePortResolver} for default port
 * resolution and {@link original.apache.http.config.Registry} for socket factory lookups.
 */
@Immutable
@Deprecated
